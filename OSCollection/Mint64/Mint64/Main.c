...
extern void gdt_commit();
extern void gdt_commit2(QWORD stage2Entry);
void kmain64Stage2();
void kmain64Stage3();
...
extern BOOL _cdecl InitializeConstructors();
/**
...
void kmain64(int addr)
{
	...
	__int64 address64 = addr;

	// 콘솔을 먼저 초기화한 후, 다음 작업을 수행
	kInitializeConsole(0, 10);
	kClearScreen();
	multiboot_info* pBootInfo = (multiboot_info*)address64;

	kPrintf("MINT64 PE Version Entered..\n");

	kPrintf("GRUB Information\n");
