...
static void kInitializeTCBPool( void )
{
    ...
    kMemSet( &( gs_stTCBPoolManager ), 0, sizeof(TCBPOOLMANAGER) );
            ...
            while( 1 )
            {
                ...
                if( pstTask->qwFlags & TASK_FLAGS_PROCESS )
                {
                    ...
                    for( i = 0 ; i < iCount ; i++ )
                    {
						...
						//20180626
						pstChildThread = (TCB*)((QWORD)(pstThreadLink)-sizeof(LISTLINK) - sizeof(QWORD) - sizeof(void*) - sizeof(QWORD));
